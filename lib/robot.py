...
class Robot(object):
    ...
    def dibujarRobot(self,screen):
        ...
        if self.estadoGiro:
            canastaRecogerProducto = self.estadoGiro[0]
            giroHacia = self.estadoGiro[1]
